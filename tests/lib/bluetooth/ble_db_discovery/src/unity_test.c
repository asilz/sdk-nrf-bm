...
void test_ble_db_discovery_service_register_null(void)
{
	...
	ret = ble_db_discovery_service_register(&db_discovery, NULL);
	TEST_ASSERT_EQUAL(NRF_ERROR_NULL, ret);
	ret = ble_db_discovery_service_register(NULL, &hrs_uuid);
	TEST_ASSERT_EQUAL(NRF_ERROR_NULL, ret);
}
...
void test_ble_db_discovery_service_register_invalid_state(void)
{
	...
	TEST_ASSERT_EQUAL(NRF_ERROR_INVALID_STATE,
			  ble_db_discovery_service_register(&db_discovery, &hrs_uuid));
}
...
void test_ble_db_discovery_service_register(void)
{
	...
	TEST_ASSERT_EQUAL(NRF_SUCCESS, ble_db_discovery_service_register(&db_discovery, &hrs_uuid));
}
